...
int main(int argc, char **argv)
{
	...
	a("(!f=r:fg=red!)          (!b=r:bg=red!)          (!s=d:st=dim!)          (dim)          (!_=2:fn=2!)");
	a("(!f=g:fg=green!)        (!b=g:bg=green!)        (!s=i:st=italics!)      (italics)      (!_=3:fn=3!)");
	a("(!f=y:fg=yellow!)       (!b=y:bg=yellow!)       (!s=u:st=under!)        (under)        (!_=4:fn=4!)");
	a("(!f=b:fg=blue!)         (!b=b:bg=blue!)         (!s=k:st=blink!)        (blink)        (!_=5:fn=5!)");
	a("(!f=m:fg=magenta!)      (!b=m:bg=magenta!)      (!s=t:st=fastblink!)    (fastblink)    (!_=6:fn=6!)");
	a("(!f=c:fg=cyan!)         (!b=c:bg=cyan!)         (!s=r:st=reverse!)      (reverse)      (!_=7:fn=7!)");
	a("(!f=w:fg=white!)        (!b=w:bg=white!)        (!s=c:st=conceal!)      (conceal)      (!_=8:fn=8!)");
	a("(!f=K:fg=grey!)         (!b=K:bg=grey!)         (!s=s:st=strikeout!)    (strikeout)    (!_=9:fn=9!)");
	a("(!f=R:fg=lightred!)     (!b=R:bg=lightred!)     (!s=f:st=fraktur!)      (fraktur)      (!_=-:fn=last!)");
	a("(!f=G:fg=lightgreen!)   (!b=G:bg=lightgreen!)   (!s=B:st=nobold!)       (nobold)       (!_=0:fn=0!)");
	a("(!f=Y:fg=lightyellow!)  (!b=Y:bg=lightyellow!)  (!s=G:st=nobright!)     (nobright)     (!_=1:fn=1!)");
