...
/* brrheap - Heap-allocated array modification */
 ...
 * returned.
 * */
BRRAPI int BRRCALL brrheap_resize(void **const array, brrsz n_elements, brrsz data_size,
    brrsz new_elements);
 ...
 * */
BRRAPI int BRRCALL brrheap_append(void **const array, brrsz *const n_elements, brrsz data_size,
 ...
 * 'data_size' is 0, 'array' is unaffected and -1 is returned.
 * */
BRRAPI int BRRCALL brrheap_prepend(void **const array, brrsz *const n_elements, brrsz data_size,
    const void *const new_data);
 ...
 * 'data_size' is 0, 'array' is unaffected and -1 is returned.
 * */
BRRAPI int BRRCALL brrheap_join(void **const array, brrsz *const n_elements, brrsz data_size,
 ...
 * */
BRRAPI int BRRCALL brrheap_split(const void *const array, brrsz n_elements, brrsz data_size,
 ...
 * is returned.
 * */
BRRAPI int BRRCALL brrheap_insert(void **const array, brrsz *const n_elements, brrsz data_size,
 ...
 * */
BRRAPI int BRRCALL brrheap_remove(void **const array, brrsz *const n_elements, brrsz data_size,
    brrsz element);
BRRAPI int BRRCALL brrheap_swap(void *const array, brrsz n_elements, brrsz data_size,
    brrsz a, brrsz b);
 ...
 * */
BRRAPI int BRRCALL brrheap_read(const void *const array, brrsz n_elements, brrsz data_size,
 ...
 * range, 'array' is unaffected and -1 is returned.
 * */
BRRAPI int BRRCALL brrheap_write(void *const array, brrsz n_elements, brrsz data_size,
 ...
 * */
BRRAPI int BRRCALL brrheap_copy(const void *const array, brrsz n_elements, brrsz data_size,
 ...
 * */
BRRAPI int BRRCALL brrheap_trim(void **const array, brrsz *const n_elements, brrsz data_size,
    brrsz n_remove);
 ...
 * */
BRRAPI void BRRCALL brrheap_clear(void **const array, brrsz *const n_elements, brrsz data_size,
    void (*clearer)(void *));

typedef int (*brrheap_comparer_t)(const void *, const void *, void*);
BRRAPI int BRRCALL brrheap_sort(void *const array, brrsz n_elements, brrsz data_size,
 ...
 * */
BRRAPI void BRRCALL brrheap_reverse(void *const array, brrsz n_elements, brrsz data_size);
/* Reverses 'total_bytes' bytes of array.
 * If 'array' is NULL, 'array' is unaffected.
 * */
BRRAPI void BRRCALL brrheap_reverse_bytes(void *const array, brrsz total_bytes);
